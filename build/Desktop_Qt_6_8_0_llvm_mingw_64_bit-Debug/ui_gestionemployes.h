...
"}"));
        ...
        stackedWidget->setGeometry(QRect(260, 90, 761, 531));
...
"}"));
        ...
        chatArea = new QTextEdit(page_2);
        chatArea->setObjectName("chatArea");
        chatArea->setContextMenuPolicy(Qt::ContextMenuPolicy::NoContextMenu);

        verticalLayout_3->addWidget(chatArea);

        inputField = new QLineEdit(page_2);
        inputField->setObjectName("inputField");

        verticalLayout_3->addWidget(inputField);
...
"}"));
    ...
    void retranslateUi(QDialog *GestionEmployes)
    {
        ...
        sendButton->setText(QCoreApplication::translate("GestionEmployes", "PushButton", nullptr));
