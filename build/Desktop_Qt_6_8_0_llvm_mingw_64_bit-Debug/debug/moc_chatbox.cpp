...
struct qt_meta_stringdata_CLASSChatBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSChatBoxENDCLASS = QtMocHelpers::stringData(
    "ChatBox",
    "sendMessage",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChatBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ChatBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSChatBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSChatBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChatBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ChatBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSChatBoxENDCLASS.stringdata0))
